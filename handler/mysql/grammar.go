...
// TableSpec selects one collection from a MySQL source.
type TableSpec struct {
	Name  string
	Query string
}

// SrcOpts is parsed argv for my-src.
type SrcOpts struct {
	URI     string
	Sources []TableSpec
	cli.BaseOpts
...
// SinkOptParser returns the optparse parser for my-sink.
func SinkOptParser() *optparse.Parser { return sinkParser }

// ParseSrcOptions parses my-src flags; target is the mysql URI.
...
// SinkOpts is parsed argv for my-sink.
